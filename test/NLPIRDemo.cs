...
//namespace test
//{
//    //http://blog.csdn.net/zengraoli/article/details/38368513
...
//            public static extern IntPtr NLPIR_ParagraphProcess(String sParagraph, int bPOStagged = 0);
...
//            {
//                //D:\Documents\Visual Studio 2015\Projects\JDCollection\test\bin\Debug
//                //D:/Documents/Visual Studio 2015/Projects/JDCollection/test/bin/Debug
//                //Console.WriteLine(System.Environment.CurrentDirectory);
//                //NLPIR_Init(System.Environment.CurrentDirectory, 0,"");
//                //
//                // 
//                //
//                if (!NLPIR_Init(System.Environment.CurrentDirectory, 0, ""))//给出Data文件所在的路径，注意根据实际情况修改。
//                {
...
//                str = Marshal.PtrToStringAnsi(intPtr);//将切分结果转换为string
//                Console.WriteLine(str);
//                intPtr = NLPIR_GetKeyWords(s, 3, false);
//                str = Marshal.PtrToStringAnsi(intPtr);//将切分结果转换为string
//                Console.WriteLine(str);
