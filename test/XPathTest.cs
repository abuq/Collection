...
namespace test
{
    class XPathTest
    {
        ...
        private void Test()
        {
            ...
            string html = httpHelper.GetHtmlByGet("http://www.hao123.com");
            doc.LoadHtml(html);
            HtmlNode rootNode = doc.DocumentNode;
            HtmlNodeCollection htmlNodeCollection = rootNode.SelectNodes("//span[@class='num']/font[last()]");
            ...
            if (htmlNodeCollection != null)
            {
                ...
                foreach (var htmlNode in htmlNodeCollection)
                {
                    ...
                    string color = htmlNode.GetAttributeValue("color", "");
            ...
            //HtmlNode htmlNode = rootNode.SelectSingleNode("")
